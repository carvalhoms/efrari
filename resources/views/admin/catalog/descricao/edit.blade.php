...
@section ('content_header')
    <div class="pageControls">
        <div><h1 class="teste"> Editar Descrição </h1></div>
    </div>
@stop
...
@section('plugins.Datatables', true)
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('descricao.update', $descricao) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href=" {{ route('descricao.index') }}" class="btn btn-danger"> Cancelar </a>
                </div>
            </form>
        </div>
    </div>
