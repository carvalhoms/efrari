...
@section('plugins.Datatables', true)
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('montadoras.update', $montadora) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Nome" value="{{ $montadora->name }}" required
