...
@section ('content_header')
    <div class="pageControls">
        <div><h1> Usuários Cadastrados </h1></div>
    <div><a href=" {{ route('user.create') }}" class="btn btn-sm btn-primary"> Cadastrar Novo </a></div>
    </div>
@stop
          ...
          <tr>
            ...
            <td class="reduzCol">
              <div class="btn-group">
                ...
                <form action="{{ route('user.destroy', ['user' => $user->id]) }}" method="POST" name="delete">
                  @csrf
                  @method('DELETE')
